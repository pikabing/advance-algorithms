...
class DCEL:
  ...
  def getAllVerticesInRegion(self, segment):
    # We need to find the half edge whose vertices
    # are that of the passed segment
    v1 = segment[0]
    v2 = segment[1]
...
def main():
  points = [(0, 5), (5, 5), (5, 0), (0, 0), (2,5), (4,0)]
...
#   myDCEL.findRegionGivenSegment([(0, 5), (0, 0)])
#   vertices = myDCEL.getAllVerticesInRegion([(0, 5), (0, 0)])
#   print('vertices', vertices)
  isAdjacent = 0
  r1 = [(0,5),(0,0)]
  r2 = [(5,5),(2,5)]

  verticesInr1 = myDCEL.getAllVerticesInRegion(r1)
  verticesInr2 = myDCEL.getAllVerticesInRegion(r2)

  for vertices1 in verticesInr1:
    for vertices2 in verticesInr2:
